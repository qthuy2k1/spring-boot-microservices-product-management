...
public class ProductCategoryServiceTest {
    ...
    @BeforeEach
    void setup() {
        productCategoryService = new ProductCategoryService(productCategoryRepository, productCategoryMapper);
    }
    ...
    void getProductCategoryById() {
        ...
        // When
        ProductCategoryResponse productCategoryResponse = productCategoryService.getProductCategoryById(id);
